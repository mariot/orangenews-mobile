 ...
 */
public class ActualiteFeed implements Comparable<ActualiteFeed>{
    ...
    public ActualiteFeed copy(){
        ActualiteFeed copy = new ActualiteFeed();
        copy.title = title;
        copy.link = link;
    ...
    public boolean equals(Object obj) {
        ...
        if (getClass() != obj.getClass())
            return false;
        ActualiteFeed other = (ActualiteFeed) obj;
        if (date == null) {
            if (other.date != null)
                return false;
    ...
    public int compareTo(ActualiteFeed another) {
