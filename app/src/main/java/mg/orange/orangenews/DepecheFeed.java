 ...
 */
public class DepecheFeed implements Comparable<DepecheFeed>{
    ...
    public DepecheFeed copy(){
        DepecheFeed copy = new DepecheFeed();
        copy.title = title;
        copy.link = link;
    ...
    public boolean equals(Object obj) {
        ...
        if (getClass() != obj.getClass())
            return false;
        DepecheFeed other = (DepecheFeed) obj;
        if (date == null) {
            if (other.date != null)
                return false;
    ...
    public int compareTo(DepecheFeed another) {
